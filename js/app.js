document.getElementById("your_details").addEventListener("change", generateSignature);
...
function generateSignature() {
	...
	switch (company) {
		...
		case "Pitstop Deals":
			location = "675 Paisley Road West, Glasgow, G51 1RP";
			logo = "https://pitstopdeals.co.uk/wp-content/uploads/2019/10/email-logos-07-e1569925437281.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 8451";
			}
		...
		case "GHSL":
			...
			logo = "https://ghsl.uk/wp-content/uploads/2019/10/email-logos-06-e1569925531138.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 8451";
			}
			url = "https://ghsl.uk";
		...
		case "Octopus Autocare":
			location = "675 Paisley Road West, Glasgow, G51 1RP";
			logo = "https://octopusautocare.co.uk/wp-content/uploads/2019/10/email-logos-04-e1569925789212.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 8451";
			}
		...
		case "RT IT Services":
			location = "675 Paisley Road West, Glasgow, G51 1RP";
			logo = "https://racetrackpitstop.co.uk/wp-content/uploads/2019/04/rtlogo-02-e1569925212420.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 7174";
			}
		...
		case "Racetrack WOW":
			location = "675 Paisley Road West, Glasgow, G51 1RP";
			logo = "https://racetrackwow.co.uk/wp-content/uploads/2019/10/email-logos-08-e1569925893766.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 8451";
			}
		...
		case "Tubbees":
			location = "675 Paisley Road West, Glasgow, G51 1RP";
			logo = "https://tubbees.co.uk/wp-content/uploads/2019/10/email-logos-05-e1569925958420.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 319 7375";
			}
		...
		case "Subway Bridgeton":
			...
			logo = "https://rtsubway.co.uk/wp-content/uploads/2020/01/subway-logo-09.png";
			if (document.getElementsByName("phone")[0].value < 1) {
				phone = "0141 530 3110";
			}
			url = "https://rtsubway.co.uk";
			if (document.getElementsByName("email")[0].value < 1) {
				email = "info@RTSubway.co.uk";
			}
			color = "#0d8b3b";
			break;
